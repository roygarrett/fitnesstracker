...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference("Workout.count") do
      post workouts_url, params: { workout: { date: @workout.date, minutes: @workout.minutes } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { date: @workout.date, minutes: @workout.minutes } }
