...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference("Exercise.count") do
      post exercises_url, params: { exercise: { name: @exercise.name, workout_type_id: @exercise.workout_type_id } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { name: @exercise.name, workout_type_id: @exercise.workout_type_id } }
