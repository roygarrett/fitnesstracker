...
class MealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal" do
    assert_difference("Meal.count") do
      post meals_url, params: { meal: { calories: @meal.calories, date: @meal.date, name: @meal.name } }
    end
  ...
  test "should update meal" do
    patch meal_url(@meal), params: { meal: { calories: @meal.calories, date: @meal.date, name: @meal.name } }
